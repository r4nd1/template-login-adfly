...
var ApiCaller = {
	call: function(endpoint, method, data, before, successCallback, errorCallback) {
	...
	getAnnouncements: function(type, $putHere, $putTopHere) {
		var annsDiv = $putHere;
		...
		this.call('/apiv1/announcements', 'get', {type: type},
			function(jqXHR, settings) { annsDiv.html('<p>' + AdFly.LOADING_STR + '</p>'); },
